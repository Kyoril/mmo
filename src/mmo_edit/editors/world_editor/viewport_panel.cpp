...
, m_gridSnapSettings(gridSnapSettings)
, m_selection(selection)
, m_sceneOutlineWindow(sceneOutlineWindow)
, m_hovering(hovering)
, m_leftButtonPressed(leftButtonPressed)
, m_rightButtonPressed(rightButtonPressed)
, m_cameraSpeed(cameraSpeed)
, m_lastAvailViewportSize(lastAvailViewportSize)
, m_lastContentRectMin(lastContentRectMin)
, m_renderCallback(std::move(renderCallback))
, m_generateMinimapsCallback(std::move(generateMinimapsCallback))
{
}
