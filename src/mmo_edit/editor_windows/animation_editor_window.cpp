...
namespace mmo
{
	AnimationEditorWindow::AnimationEditorWindow(const String& name, proto::Project& project, EditorHost& host)
		: EditorEntryWindowBase(project, project.animations, name)
		, m_host(host)
	{
		EditorWindowBase::SetVisible(false);

		m_hasToolbarButton = false;
		m_toolbarButtonText = "Animations";
	}

	void AnimationEditorWindow::DrawDetailsImpl(proto::AnimationEntry& currentEntry)
	{
