...
namespace mmo
{
	...
	namespace spell_effects
	{
		...
		// New spell effect types must ALWAYS be appended before Count_ with the next sequential value.
		enum Type
		{
			None                    = 0,
			InstantKill             = 1,
			...
			Weapon                  = 22,
			Defense                 = 23,
			PersistentAreaAura      = 24,
			Summon                  = 25,
			Leap                    = 26,
			Energize                = 27,
			WeaponPercentDamage     = 28,
			TriggerMissile          = 29,
			OpenLock                = 30,
			LearnSpell              = 31,
			SpellDefense            = 32,
