...
namespace mmo
{
	...
	public:
		...
		/// @brief Whether texture/SRV/(UAV) creation succeeded. GraphicsDeviceD3D11::CreateVolumeTexture
		///        checks this and returns nullptr instead of a half-constructed volume on failure.
