...
namespace mmo
{
	...
	ExpressionIndex MaterialCompilerNull::AddMax(ExpressionIndex first, ExpressionIndex second)
	{
		return IndexNone;
	}
	
	ExpressionIndex MaterialCompilerNull::AddMin(ExpressionIndex first, ExpressionIndex second)
	{
		return IndexNone;
	}
	...
	ExpressionIndex MaterialCompilerNull::AddTime()
	{
		return IndexNone;
	}

	ExpressionIndex MaterialCompilerNull::AddRotator(ExpressionIndex coordinates, ExpressionIndex center, ExpressionIndex rotation)
	{
		return IndexNone;
	}

	ExpressionIndex MaterialCompilerNull::AddFresnel(ExpressionIndex exponent, ExpressionIndex baseReflectFraction, ExpressionIndex normal)
	{
		return IndexNone;
	}

	ExpressionIndex MaterialCompilerNull::AddPixelDepth()
	{
		return IndexNone;
	}

	ExpressionIndex MaterialCompilerNull::AddSceneDepth()
	{
		return IndexNone;
	}

	ExpressionIndex MaterialCompilerNull::AddScreenPosition()
	{
		return IndexNone;
	}

	ExpressionIndex MaterialCompilerNull::AddSaturate(ExpressionIndex input)
	{
		return IndexNone;
	}

	ExpressionIndex MaterialCompilerNull::AddSceneColor(ExpressionIndex screenOffset)
	{
		return IndexNone;
	}

	ExpressionIndex MaterialCompilerNull::AddScreenSpaceReflection(ExpressionIndex worldNormal,
	...
	ExpressionIndex MaterialCompilerNull::AddGlobalScalarParameterExpression(std::string_view name)
	{
		return IndexNone;
	}

	ExpressionIndex MaterialCompilerNull::AddGlobalVectorParameterExpression(std::string_view name)
	{
		return IndexNone;
	}
}
