		...
		LUABIND_MODULE(m_luaState.get(),
					   ...
					   luabind::scope(
						   luabind::class_<UnitHandle>("UnitHandle")
							   ...
							   .def("GetKnownClassCount", &UnitHandle::GetKnownClassCount)
							   .def("GetKnownClassName", &UnitHandle::GetKnownClassName)
							   .def("GetKnownClassLevel", &UnitHandle::GetKnownClassLevel)
							   .def("GetKnownClassMaxLevel", &UnitHandle::GetKnownClassMaxLevel)
							   .def("GetKnownClassXp", &UnitHandle::GetKnownClassXp)
							   .def("GetKnownClassXpToNextLevel", &UnitHandle::GetKnownClassXpToNextLevel)
