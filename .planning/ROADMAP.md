...
Plans:
- [x] 03-01-PLAN.md — NPC Lua frame polish: fix TrainerFrame_OnTrainerUpdate, add NPC name to QuestFrame gossip header, audit VendorFrame completeness
...
- [x] 03-03-PLAN.md — UseObject server handler + GameWorldObjectS fix: fix type TODO, door/chest branching in Use(), OnGameObjectUse handler end-to-end
