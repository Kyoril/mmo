#!/usr/bin/env python3
"""Helpers for compiling and loading MMO protobuf modules for NPC tooling."""
...
def compile_proto_modules(project_root: Path) -> Path:
    ...
    out_dir = Path(tempfile.mkdtemp(prefix="mmo_npc_proto_"))
...
def load_modules(project_root: Path) -> dict[str, object]:
    ...
    module_names = {
        "units": "units_pb2",
        "factions": "factions_pb2",
        "faction_templates": "faction_templates_pb2",
        "unit_loot": "unit_loot_pb2",
        "loot_entry": "loot_entry_pb2",
        "vendors": "vendors_pb2",
        "trainers": "trainers_pb2",
        "gossip_menus": "gossip_menus_pb2",
        "maps": "maps_pb2",
        "unit_classes": "unit_classes_pb2",
        "model_data": "model_data_pb2",
        "classes": "classes_pb2",
        "races": "races_pb2",
        "quests": "quests_pb2",
        "zones": "zones_pb2",
